...
<script src="/themes/ophimtv/rating2/jquery.raty.js"></script>
<script>
    var rated = false;
    $('#star').raty({
        number: 10,
        starHalf: '/themes/ophimtv/rating2/images/star-half.png',
        starOff: '/themes/ophimtv/rating2/images/star-off.png',
        starOn: '/themes/ophimtv/rating2/images/star-on.png',
